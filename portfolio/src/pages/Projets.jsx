...
function Projets() {
  ...
  const projects = [
    {
      ...
      alt: "Capture d'écran du projet Booki, une plateforme de réservation",
      paragraphe:
        "Ce projet a pour but d'intégrer la maquette de la page d'accueil d'un site de location d'hébergements de vacances nommé Booki.",
      contenu_popup: "https://github.com/3670818/html",
      contenu_popup1: "https://3670818.github.io/html/",
    },
    {
      ...
      contenu_popup:
        "https://github.com/3670818/projet4_nina_carducci/tree/main/Nina-Carducci-Dev",
      contenu_popup1: "https://3670818.github.io/Nina-Carducci-Dev/",
    },
    {
      id: 3,
      ...
      alt: "Capture d'écran de l'application Mon vieux grimoire",
      paragraphe:
        "Ce projet a pour but d'intégrer le backend du site Gestion des livres : ajout, mise à jour et suppression de livres. Notation des livres : possibilité de noter les livres. Authentification : inscription et connexion des utilisateurs.",
      contenu_popup:
        "https://github.com/3670818/p6_le_vieux_grimoire",
    },
    {
      id: 4,
      title: "Sophie Bluel",
      ...
      alt: "Capture d'écran du portfolio Sophie Bluel",
      paragraphe:
        "Projet 3 du parcours développeur web OpenClassrooms. Implémentation des fonctionnalités dynamiques pour le site de l'architecte Sophie Bluel. Utilisation de JavaScript natif, sans framework. Backend fourni avec Swagger.",
      contenu_popup: "https://github.com/3670818/projet3",
      contenu_popup1: "https://3670818.github.io/projet3/",
    },
  ];
  ...
  return (
    <div className="activites-a-marseille">
      <section className="acti">
        <h2 className="section-title2" id="activite">
          Mes Projets
        </h2>

        <span className="sous-titre-projets">
          Quelques exemples de réalisations effectuées durant la formation
        </span>
            ...
            <div key={project.id}>
              ...
              >
                <article className="card2">
                  ...
                  <div className="card-content1">
                    <div className="card-txt-activité-marseille">
                      <h3 className="card-title-activite">
                        {project.title}
                      </h3>
                    </div>
                  </div>
        ...
        {selectedProject && (
          ...
          >
            ...
            <div className="popup-links">
              <a
                href={selectedProject.contenu_popup}
                target="_blank"
              ...
              {selectedProject.contenu_popup1 && (
                <a
                  href={selectedProject.contenu_popup1}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Lien du site
